...
#include <stdint.h>
#include "../semaphores/sem_internal.h" // Para spinlock_t
 ...
 * - Thread-safe: Todas las operaciones están protegidas por spinlocks para evitar
 *   race conditions en accesos concurrentes.
 */
...
// Thread-safe: usa spinlock internamente.
...
// Retorna 0 si OK; -1 si pid/whichPipe inválidos.
...
// Retorna id de pipe enlazada o -1 si no hay/inválido.
...
// Retorna 1 si hay datos listos; 0 si no; -1 si fd inválido.
// Thread-safe: usa spinlock internamente.
